...
until [ $COUNTER -lt 1 ];  do
	...
	. ${BASEDIR}scripts/run_scale.sh --robots $ROBOTS --mu $MU --stepsPerCandidate $STEPSPERCANDIDATE --mutationRate $MUTATIONRATE --crossoverRate $CROSSOVERRATE --reEvaluationRate $REEVALUATIONRATE --initialMutationStepSize $INITIALMUTATIONSTEPSIZE --startHormones $STARTHORMONES --startRules $STARTRULES --seed $SEED &
